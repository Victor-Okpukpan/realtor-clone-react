  ...
  return (
    <main className="px-2 max-w-md mx-auto">
        ...
        <form onSubmit={onSubmit}>
            ...
            {/* Submit button */}
            <button type="submit" className="w-full px-7 py-3 bg-blue-600 text-white font-medium text-sm uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:shadow-lg focus:bg-blue-700 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out mb-6">Edit Listing</button>
